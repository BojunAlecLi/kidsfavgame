...
import {
  BaseTexture,
  Texture
} from "./chunk-L4BOYIPE.js";
import {
  SerializationHelper
} from "./chunk-P5QAY2RK.js";
import {
  __decorate,
  serialize,
  serializeAsColor4
...
import {
  ...
  Vector3,
  _ObserveArray
} from "./chunk-IKIFT3TF.js";
import {
  HasStencilAspect,
  ThinEngine,
  WebGLDataBuffer,
  WebGLHardwareTexture
} from "./chunk-JJFP4JPA.js";
import {
  EffectWrapper
} from "./chunk-ALHIJ5AN.js";
import {
  GetClass,
  RegisterClass
...
var RenderTargetTexture = class _RenderTargetTexture extends Texture {
  ...
  isReadyForRendering() {
    if (!this._dumpToolsLoading) {
      ...
      import("./dumpTools-UKJCIOTX.js").then((module) => this._dumpTools = module);
    }
...
var PostProcess = class _PostProcess {
  ...
  _gatherImports(useWebGPU = false, list) {
    if (useWebGPU && this._webGPUReady) {
      list.push(Promise.all([import("./postprocess.vertex-VLSCSTUJ.js")]));
    } else {
...
ThinEngine.prototype.createPrefilteredCubeTexture = function(rootUrl, scene, lodScale, lodOffset, onLoad = null, onError = null, format, forcedExtension = null, createPolynomials = true) {
  const callback = async (loadData) => {
    ...
    const { DDSTools } = await import("./dds-OCEJVMQT.js");
    const textures = [];
...
var ThinPassPostProcess = class _ThinPassPostProcess extends EffectWrapper {
  _gatherImports(useWebGPU, list) {
    if (useWebGPU) {
      ...
      list.push(Promise.all([import("./pass.fragment-HBIXX7VK.js")]));
    } else {
      list.push(Promise.all([import("./pass.fragment-YB3NB4MX.js")]));
    }
...
var ThinPassCubePostProcess = class _ThinPassCubePostProcess extends EffectWrapper {
  _gatherImports(useWebGPU, list) {
    if (useWebGPU) {
      this._webGPUReady = true;
      list.push(Promise.all([import("./passCube.fragment-SAJ2TKD5.js")]));
    } else {
      list.push(Promise.all([import("./passCube.fragment-MOVRLZH5.js")]));
    }
    super._gatherImports(useWebGPU, list);
  }
  /**
...
var ProcessAsync = async (texture, width, height, face, lod) => {
  ...
  if (!engine.isWebGPU) {
    if (texture.isCube) {
      await import("./lodCube.fragment-LLVJXJKX.js");
    } else {
      await import("./lod.fragment-XGAG3X4Y.js");
    }
  } else {
    if (texture.isCube) {
      await import("./lodCube.fragment-OZI7LR3H.js");
    } else {
      await import("./lod.fragment-XXIV3TYW.js");
    }
  }
  let lodPostProcess;
  if (!texture.isCube) {
...
//# sourceMappingURL=chunk-VEWW67E5.js.map
