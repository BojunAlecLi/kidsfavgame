...
async function _CreateDumpRenderer() {
  if (!_enginePromise) {
    _enginePromise = new Promise((resolve, reject) => {
      ...
      import("./thinEngine-IRJ5RNK2.js").then(({ ThinEngine: thinEngineClass }) => {
        var _a;
        ...
        import("./pass.fragment-YB3NB4MX.js").then(({ passPixelShader }) => {
          if (!engine) {
...
//# sourceMappingURL=chunk-FYXISEXG.js.map
