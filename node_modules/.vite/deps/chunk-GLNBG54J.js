import {
  Scene
} from "./chunk-5G3735L6.js";
import {
  ApplyPostProcess,
  CubeMapToSphericalPolynomialTools,
  PostProcess,
  SphericalPolynomial
} from "./chunk-VEWW67E5.js";
import {
  BaseTexture
...
import {
  DumpDataAsync
} from "./chunk-FYXISEXG.js";
import {
  Tools
} from "./chunk-CYRARFJQ.js";
import {
  InternalTexture
...
var RGBDTextureTools = class {
  ...
  static ExpandRGBDTexture(texture) {
    ...
    const expandRGBDTexture = async () => {
      ...
      internalTexture.isReady = false;
      if (isWebGPU) {
        await import("./rgbdDecode.fragment-RTE64L2I.js");
      } else {
        await import("./rgbdDecode.fragment-5NIDNMGZ.js");
      }
  ...
  static async EncodeTextureToRGBD(internalTexture, scene, outputTextureType = 0) {
    if (!scene.getEngine().isWebGPU) {
      await import("./rgbdEncode.fragment-TDZCGIDP.js");
    } else {
      await import("./rgbdEncode.fragment-VCEPKQBR.js");
    }
...
//# sourceMappingURL=chunk-GLNBG54J.js.map
